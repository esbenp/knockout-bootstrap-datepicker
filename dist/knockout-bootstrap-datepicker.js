(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['knockout', 'bootstrap-datepicker', 'jquery'], factory);
  } else if (typeof exports === 'object') {
    module.exports = factory(require('knockout'), require('bootstrap-datepicker'), require('jquery'));
  } else {
    root.ko = factory(root.ko, root.$.fn.Datepicker, root.jQuery);
  }
}(this, function(ko, datepicker, $) {
